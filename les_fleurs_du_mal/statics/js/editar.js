...
*/      var a = ['id_status','id_fecha_creacion','id_fecha_modificacion'];
        ...
        document.getElementById("id_fecha_modificacion_libro").value= fecha
      ...
      var a = ['id_status_libro','id_fecha_creacion_libro','id_fecha_modificacion_libro'];
        ...
        var url = "/biblioteca/reporte/libros/"+fechainicial+"/"+fechafinal;
        ...
        function desactivarA(){
            ...
            if(ban){
                if(op=="1"){
                    ...
                    if(document.getElementById("autores2")==null){

                    }else{
                        document.getElementById("autores2").style.display = 'none';
                    }
                }else if(op == "2"){
                    ...
                    location.href  ="http://127.0.0.1:8000/biblioteca/reportesC/";
                }
        ...
        function desclickearCat(){
        desactivarC();
        document.getElementsByName("opcion")[0].checked=false;

        }

        function desclickearAut(){
        ...
        function cal2(){
            ...
            document.getElementById("categorias2").style.display = 'none';

            }else if(op == "2"){
            location.href = "http://127.0.0.1:8000/biblioteca/reportesA";
            }
            else{
             document.getElementById("fechas").style.display = 'none';
            document.getElementById("autores").style.display = 'none';
